...
1986.E o objetivo é verificar em quanto foi o aumento do número de casos.
...
H0 como sendo a hipótese de que não houve um aumento do número de casos de cancer
H1 como sendo a hipótese de que houve um aumento do número de casos de cancer

Tomando o nível de significancia como 0.001

Vamos rejeitar H0, que é a a hipótese de que não houve um aumento nos casos de cancer.
...
```
  ...
  resultado1 <- shapiro.test(x1)
p_valor1 = resultado1$p.value

p_valor1 <= significancia

resultado2 <- shapiro.test(x2)
